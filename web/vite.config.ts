...
const oddsMath = {
  ...
  gain: tex(String.raw`\text{bonus} = \begin{cases} 0 & \text{safe, guaranteed, or no stake} \\ \omega\operatorname{round}\!\bigl(100/P\bigr)\ \text{coins} & r \ge 1 \end{cases}`),
  ...
  jackpot: tex(String.raw`\text{jackpot} = \text{bonus} + \omega\,\max\!\bigl(0,\ s + \mathrm{gain} - \mathrm{cap}\bigr)`),

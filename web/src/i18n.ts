...
const dict = {
  ko: {
    ...
    tutorial: [
      ...
      { title: '시간 충전', desc: '60💰로 이번 시간의 클릭을 즉시 재충전해요.' },
  ...
  en: {
    ...
    refillDesc: "Instantly refill this hour's clicks",
    ...
    tutorial: [
      ...
      { title: 'Time recharge', desc: "Instantly refill this hour's clicks for 60💰." },

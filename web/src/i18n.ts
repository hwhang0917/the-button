...
const dict = {
  ko: {
    ...
    menuMute: '음소거',
    menuUnmute: '소리 켜기',
    menuFanfareMute: '팡파레만 끄기',
    menuFanfareUnmute: '팡파레 켜기',
    menu: '메뉴',
    close: '닫기',
    language: '언어 변경',
    sellStreak: '스트릭 판매',
    sellDesc: '현재 별을 코인으로 바꾸고 처음부터 다시 시작해요',
    sellStreakConfirm: '⭐ ★{n}  →  💰 {c}\n\n스트릭이 전부 코인으로 바뀌고\n처음부터 다시 시작해요. 계속할까요?',
    maxLevel: 'MAX',
    charmName: '행운 부적',
  ...
  en: {
    ...
    menuMute: 'Mute sound',
    menuUnmute: 'Unmute',
    menuFanfareMute: 'Mute fanfares only',
    menuFanfareUnmute: 'Unmute fanfares',
    menu: 'Menu',
    close: 'Close',
    language: 'Change language',
    sellStreak: 'Sell streak',
    sellDesc: 'Trade your current stars for coins and start over',
    sellStreakConfirm: '⭐ ★{n}  →  💰 {c}\n\nYour entire streak converts to coins\nand you start over. Continue?',
    maxLevel: 'MAX',

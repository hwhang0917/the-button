...
const dict = {
  ko: {
    ...
    tutorial: [
      ...
      { title: '카드 팩', desc: '30💰로 랜덤 카드 1장! 모든 티어가 나올 수 있고, 높은 티어일수록 희귀해요.' },
      ...
      { title: '컬렉션', desc: '성공 시 드랍되는 카드! 부적으로 쓰면 보상 손해 없이 확률을 올리고, 3장을 합성해 상위 등급으로 — 발견한 카드는 소모해도 도감에 남아요.' },
  ...
  en: {
    ...
    packName: 'Card pack',
    packDesc: 'One random card — higher tiers are rarer!',
    ...
    oddsSimple: [
      ...
      '🍀 Lucky charm adds to your odds; 🃏 talismans boost only the roll (reward unchanged).',
    ...
    oddsChanceDesc: 'Risk divides the base chance and charm adds on top. The talisman bonus (T) only boosts the roll.',
    oddsRollDesc: 'The server draws an integer 0-99 with crypto/rand; below P wins — the client only renders.',
    oddsGainDesc: 'The payout uses P without the talisman bonus — a talisman is pure upside on the odds.',
    ...
    tutorial: [
      ...
      { title: 'Card pack', desc: 'A random card for 30💰! Any tier can appear — higher tiers are rarer.' },
      ...
      { title: 'Collection', desc: 'Cards drop on success! Talismans boost your odds without touching the reward, and 3 fuse into the next rarity — discovered cards stay in the collection even at ×0.' },

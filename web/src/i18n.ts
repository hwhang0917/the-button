...
const dict = {
  ko: {
    ...
    oddsMore: '📐 자세한 수식 보기',
    oddsVars: 's = 현재 별, r = 리스크 레벨(0~3), c = 행운 부적 레벨, p = 프리스티지, T·M·B = 장착한 카드의 확률·배수·추가 별 (없으면 T=B=0, M=1)',
  ...
  en: {
    ...
    oddsVars: "s = current stars, r = risk level (0-3), c = lucky charm level, p = prestige, T·M·B = the armed card's chance bonus, star multiplier and flat star bonus (T=B=0, M=1 with no card)",

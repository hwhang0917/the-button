...
const dict = {
  ko: {
    ...
    tutorial: [
      ...
      { title: '랭킹', desc: '프리스티지 티어 → 별 → 포인트 순으로 겨뤄요. ★15 달성 시 프리스티지로 별 티어를 승급하세요!' },
    ],
  ...
  en: {
    ...
    rankOrder: 'Order: prestige tier → stars → points',
    shop: 'Skill shop',
    ...
    tutorial: [
      ...
      { title: 'Ranking', desc: 'Ranked by prestige tier → stars → points. Hit ★15 and PRESTIGE to promote your star tier!' },
    ],
